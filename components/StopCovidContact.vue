    ...
    <div class="container">
      <div class="columns is-spaced">
        <div data-aos="fade-in" class="column is-two-fifths">
          <div class="content">
            <h2 class="title-mono is-size-1">{{$t('corporate-donors-contact.title')}}</h2>
            <p class="is-size-5 has-text-weight-light has-text-grey"
            v-html="this.$t('corporate-donors-contact.subtitle')"></p>
          </div>
        </div>
        <div data-aos="fade-in" class="column is-one-sixth">
        </div>
        <div data-aos="fade-in" class="column is-half">
          <form name="corporate-donors" action="/thank-you" netlify-honeypot="bot-field" method="post" netlify>
            ...
            <div class="field">
              <div class="control">
                <button class="button is-medium is-primary" type="submit">{{$t('stop-covid-contact.form.button')}}</button>
