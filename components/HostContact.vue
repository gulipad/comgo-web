        ...
        <div data-aos="fade-in" class="column is-half">
          <form id="host-a-project" class="contact-form" name="host-a-project" netlify>
            ...
            <div class="field">
              ...
              <div class="control">
                <input class="input" type="email" name="_replyto" v-bind:placeholder="this.$t('host-contact.form.email-placeholder')" required="true" value="">
              </div>
            </div>
            <div class="field">
              <label class="label">{{$t('host-contact.form.message')}}</label>
              <div class="control">
                <textarea class="textarea" name="_message" maxlength="500" required="true" v-bind:placeholder="this.$t('host-contact.form.message-placeholder')"></textarea>
              </div>
            </div>
            <div class="field">
              <div class="control">
